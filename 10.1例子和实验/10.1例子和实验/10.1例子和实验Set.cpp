...
// 10.1例子和实验Set.cpp : CMy101例子和实验Set 类的实现
//
...
// 代码生成在 2020年6月2日, 23:12

IMPLEMENT_DYNAMIC(CMy101例子和实验Set, CRecordset)

CMy101例子和实验Set::CMy101例子和实验Set(CDatabase* pdb)
	: CRecordset(pdb)
{
	m_ID = 0;
	m_1 = L"";
...
void CMy101例子和实验Set::DoFieldExchange(CFieldExchange* pFX)
{
...
#ifdef _DEBUG
void CMy101例子和实验Set::AssertValid() const
{
	CRecordset::AssertValid();
}

void CMy101例子和实验Set::Dump(CDumpContext& dc) const
{
	CRecordset::Dump(dc);
}
#endif //_DEBUG
